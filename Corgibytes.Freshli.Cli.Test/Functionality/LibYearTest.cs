...
public class LibYearTest : FreshliTest
{
    ...
    public void Validate_expected_libyears(DateTimeOffset releaseDateCurrentVersion, DateTimeOffset releaseDateLatestVersion, double expectedLibYear,
    ...
    {
        {
            ...
            new(2019, 1, 3, 0, 0, 0, TimeSpan.Zero),
            new(2021, 8, 25, 0, 0, 0, TimeSpan.Zero),
            2.65,
            2
        },
        {
        ...
        },
        {
            ...
            new(2022, 6, 14, 0, 0, 0, TimeSpan.Zero),
            new(2021, 9, 21, 0, 0, 0, TimeSpan.Zero),
            0.73,
            2
        },
        {
            ...
            new(1990, 1, 3, 0, 0, 0, TimeSpan.Zero),
        ...
        },
        {
            ...
            new(2004, 12, 31, 0, 0, 0, TimeSpan.Zero),
            1.00,
            2
        }
    };

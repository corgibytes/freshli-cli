...
## Generating an Activity/Event diagram

A Mermaid.js diagram of the relationships between the classes implementing `IApplicationActivity` and `IApplicationEvent` can be generated by running:
